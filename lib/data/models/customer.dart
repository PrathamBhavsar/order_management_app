...
class Customer {
  ...
  factory Customer.fromJson(Map<String, dynamic> json) => Customer(
        ...
        email: json["Email"] ?? "",
        fax: json["Fax"],
        isCostcutter: (json['IsCostcutter'] ?? 0) == 1,
        isDeleted: (json['IsDeleted'] ?? 0) == 1,
        isHenderson: (json['IsHenderson'] ?? 0) == 1,
        isMessageEnabled: (json['IsMessageEnabled'] ?? 0) == 1,
        isMusgrave: (json['IsMusgrave'] ?? 0) == 1,
        isPredictionEnable: (json['IsPredictionEnable'] ?? 0) == 1,
        isTemplateEnable: (json['IsTemplateEnable'] ?? 0) == 1,
